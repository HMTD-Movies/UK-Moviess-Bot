...
async def auto_filter(client, msg, spoll=False):
    if not spoll:
        ...
        if 2 < len(message.text) < 100:
            ...
            if not files:
                await client.send_message(req_channel,f"#Requested_Movie 👇🏻\n\n➟ 🎥 Movie Name :- {search}\n➟ 💁🏻 Requested By :- {message.from_user.first_name}\n➟ 🆔 User ID :- {message.from_user.id}\n\n➟ 👨🏻‍✈️ User Link :- {message.from_user.mention}", reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("✔️ Upload Done", callback_data="close_data")]]))
                await message.reply_text(text=f"Hello 👋🏻 {message.from_user.mention} ❤️,\n\nYour Request Has Been Sent to Our Admin's Dashboard.!\nPlease Keep Some Patience..!\nThey Will Upload This Movie 🎥 as Soon as Possible\n\n➟ 🎥 Movie Name : {search}\n➟ 👨🏻‍✈️ Requested By : {message.from_user.first_name}\n➟ 👨🏻‍✈️ User Link :- {message.from_user.mention}\n\n<a href=https://t.me/UK_Movies_Bot><b>UK Movies Bot</b></a>\n\nAdmin Support :-<a href=https://t.me/HMTD_Karthik><b>Karthik</b></a>", reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("©️ Add me to Your Group", url=f'http://t.me/{temp.U_NAME}?startgroup=true')],[InlineKeyboardButton("📢 Update Channel", url="https://t.me/UK_Movies_Zone_Updates"), InlineKeyboardButton("👥 Support", url="https://t.me/HMTD_Discussion_Group"), InlineKeyboardButton("🔥 Main Channel", url="https://t.me/HMTD_Links")],[InlineKeyboardButton("Thank You ❤️ UK Movies", callback_data="close_data")]]))
